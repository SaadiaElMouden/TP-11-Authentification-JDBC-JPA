...
public class DatabaseInitializer {
    ...
    CommandLineRunner init(RoleRepository roleRepo, UserRepository userRepo, BCryptPasswordEncoder encoder) {
        return args -> {
            ...
            User admin = new User(null, "admin", encoder.encode("admin1234"), true, List.of(adminRole, userRole));
            User user = new User(null, "user", encoder.encode("user1111"), true, List.of(userRole));
